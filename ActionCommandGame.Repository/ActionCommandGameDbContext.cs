...
namespace ActionCommandGame.Repository
{
    public class ActionCommandGameDbContext: IdentityDbContext
    {
        ...
        public void GenerateNegativeGameEvents()
        {
            ...
            {
                Name = "The \"Microverse,\"",
                Description = "A dimension that is much smaller than the prime dimension, and is inhabited by tiny, insect-like creatures, leaded by Zeep.",
            ...
            NegativeGameEvents.Add(new NegativeGameEvent
            {
                ...
                Description = "A dimension that is filled with toxic gas and is inhabited by versions of Rick Sanchez who have become mutated and extremely aggressive as a result of exposure to the gas.",
                DefenseWithArmorDescription = "Thanks to your armor you are safe from the toxicity.",
                DefenseWithoutArmorDescription = "You are covered with green slime! You are starting to turn toxic!! Let's get out of here!",
                DefenseLoss = 5,
                Probability = 100
            });
            NegativeGameEvents.Add(new NegativeGameEvent
            {
                ...
                DefenseWithoutArmorDescription = "You have to smuggle the MegaSeeds through inter-dimensional customs. Insert the MegaSeed!! IT HURTS SO BAD!!",
                DefenseLoss = 500,
                Probability = 50
            });
        }
        ...
        {
            Items.Add(new Item { Name = "Emmy Award", Description = "You just won an Emmy. Do you feel special now?", Price = 10 , ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKZJVDlxXxFRXfHZuIKubkobEsR0Go87_uyw&usqp=CAU" });
            Items.Add(new Item { Name = "Szechuan Sauce", Description = "One of Rick's ultimate dreams.", Price = 100000 , ImageUrl = "https://www.tbsnews.net/sites/default/files/styles/big_2/public/images/2022/03/23/untitled-3.png" });
            Items.Add(new Item { Name = "Killer Body", Description = "Yes, show everyone how much money you are willing to spend on something useless!", Price = 500000 , ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCQrap2IbIeRh2lW8HycXhb7_-C9KUJG21vw&usqp=CAU" });
        }
