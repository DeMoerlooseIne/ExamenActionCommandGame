...
public static class ServiceResultExtensions
{
    ...
    public static ServiceResult<T> ItemNotFound<T>(this ServiceResult<T> serviceResult)
    {
        var message = new ServiceMessage
        {
            Code = "ItemNotFound",
            Message =
                "What? I don't know what item you are talking about. Come back when you have more information about this item.",
            MessagePriority = MessagePriority.Error
        };
        serviceResult.Messages.Add(message);
    ...
    {
        foreach (var serviceMessage in messages) serviceResult.Messages.Add(serviceMessage);
