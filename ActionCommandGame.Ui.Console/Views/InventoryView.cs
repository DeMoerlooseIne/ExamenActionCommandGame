...
internal class InventoryView : IView
{
    ...
    public async Task Show()
    {
        ...
        foreach (var playerItem in inventoryResult.Data) ShowPlayerItem(playerItem);
    }
    ...
    private static void ShowPlayerItem(PlayerItemResult playerItem)
    {
        ...
        if (playerItem.Fuel > 0) ConsoleWriter.WriteText($"\t\tFuel: {playerItem.RemainingFuel}/{playerItem.Fuel}");
